...
function App() {
  ...
  const [inputValue, setInputValue] = useState<string>("รายการใหม่")
 ...
 const clearCompleted = () => {
  ...
  const completedCount = todos.filter(e => e.completed).length // แก้ไขให้ถูกต้อง
        ...
        {filteredTodos.length === 0 ? (
          ...
          <li className="empty-state">
            ...
            <p>
              ...
              {filter === 'all' && '🌚 ยังไม่มีรายการอะไรเลย เพิ่มสิๆๆๆ'}
              {filter === 'active' && '🌝 ยังไม่มีรายการอะไรเลย เพิ่มสิๆๆๆ'}
              {filter === 'completed' && '🌞 ยังไม่มีรายการอะไรเลย เพิ่มสิๆๆๆ'}
            </p>
          </li>
        ) : (
